...
- Back covers: 1974–1999 ✓, 2013 ✓ (id=5 [1977], id=115 [1984], id=298 [1989], id=299 [1989], id=460 [1993], id=474 [1993], id=754 [1999] returned 404 — no image exists on source; id=420 [1992] back added manually; id=179 [1986] re-downloaded after bad reference)
